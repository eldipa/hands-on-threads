...
chklibs:
	...
	cppcheck --enable=all --language=c++ --std=c++17 --error-exitcode=1 --suppress=unmatchedSuppression --suppress=duplInheritedMember --suppress=missingIncludeSystem --suppress=unusedFunction --inline-suppr libs/*.h libs/*.cpp
	./test_queue
